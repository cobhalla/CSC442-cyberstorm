...
cypher = '''StaueofZsABCDEFGHIJKLMNOPQRTUVWXY bcdghijklmnpqrvwxyz0987654321.,?!+='":;@#$%*'''
...
def decrypt():
    ...
    for i in range(0,mLen):
        ...
        if(curr_char != '[' or curr_char != ']' or curr_char != '{' or curr_char != '}' or curr_char != '-'):
            ...
            curr_key_ord = int(alpha.index(str(curr_char)))
            print("in:",curr_char," index:",curr_key_ord)
            cypherChar = cypher[curr_key_ord]
